...
class SHA3256Test {
    ...
    void test_SHA3_256() {
        ...
        SHA3256 sha3256 = new SHA3256();
        byte[] result1 = sha3256.digest(input1);
        byte[] result2 = sha3256.digest(input2);
        ...
        for (int i = 0; i < 1000; i++) {
            byte[] result3 = sha3256.digest(input1);
    ...
    void test_SHA3_256_String() {
        ...
        StringDigest sha3256 = new SHA3256();
        byte[] result1 = sha3256.digest(input1);
        byte[] result2 = sha3256.digest(input2, "UTF-8");
        byte[] result3 = sha3256.digest(input1, StandardCharsets.UTF_8);
        ...
        for (int i = 0; i < 1000; i++) {
            byte[] result4 = sha3256.digest(input1);
